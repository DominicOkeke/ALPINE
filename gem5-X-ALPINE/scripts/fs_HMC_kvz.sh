#!/bin/bash
# ALPINE gem5-X-ALPINE HMC Kvazaar Simulation Script
...
echo "Starting ALPINE gem5-X-ALPINE HMC Kvazaar Simulation"
echo "===================================================="
